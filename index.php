            ...
            <div class="tab-pane fade active show" id="features-tab-1" role="tabpanel">
              <div class="row">
                <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0 d-flex flex-column justify-content-center">
                  <h3>Compromisso com a Justiça e Excelência Jurídica</h3>
                  <p class="fst-italic">
                  Nossa missão é colaborar com a administração da Justiça a partir da ampla e sólida defesa dos interesses e necessidades específicas de nossos clientes, prestando assim serviços jurídicos com excelência, oferecendo soluções inovadoras, com total segurança jurídica, para obtenção de resultados que garantam a satisfação de seus nossos clientes. Além disso, aprimorar e compartilhar constantemente o conhecimento, praticando e transmitindo valores éticos.
                  </p>
                  <ul>
                    <li><i class="bi bi-check2-all"></i> <span>Defesa Estratégica e Personalizada</span></li>
                    <li><i class="bi bi-check2-all"></i> <span>Excelência e Inovação</span></li>
                    <li><i class="bi bi-check2-all"></i> <span>Ética e Compartilhamento de Conhecimento</span></li>
                  </ul>
                </div>
